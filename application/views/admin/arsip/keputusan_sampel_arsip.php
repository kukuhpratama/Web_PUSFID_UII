						...
						<div class="col-md-6 pull-left">
							<p class="text-center">
								...
								<?php if ($keputusan['status_keputusan']=="Di Kembalikan"): ?>
									...
									<br>
									<br>
									<u><?php echo $keputusan['nama_pegawai']; ?></u>
								</p>
							</div>
							<div class="col-md-6 pull-right">
								<p class="text-center">
									...
									<?php if ($keputusan['status_keputusan']=="Di Kembalikan"): ?>
										...
										<br>
										<br>
										<u><?php echo $penerima['nama_klien']?></u>
									</p>
								</div>
							</div>
							<a href="<?php echo base_url("admin/data/arsip"); ?>" class="btn btn-primary btn-sm hidden-print"><i class="fa fa-chevron-left"></i>  Kembali</a>
							<a href="#" onclick="window.print();" class="btn btn-sm btn-success pull-right hidden-print"><i class="fa fa-print"></i> Print</a> 
						</div>
					</div>
				</section>
			</div>
