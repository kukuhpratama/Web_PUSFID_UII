<div id="page-wrapper">
    <div class="box-header">
        <h3 class="box-title  hidden-print" style="font-size: 20px; opacity: 0.7; margin-left: 4px"><b>Detail Sampel Surat</b></h3>
    </div>
        ...
        <div class="box box-info">
            ...
            <table class="table-bordered table">
                <tbody>
                    ...
                    <td colspan="2">Tim Penguji : PUSFID UII </td>
                    <tr>
                ...
                <br>
                <a href="<?php echo base_url("admin/data/sampel_arsip/$detail_sampel[id_permohonan]") ?>" class="btn btn-primary hidden-print"><i class="fa fa-chevron-left"></i> Kembali</a>
