        ...
        <div class="box box-info">
            <div class="box-body">
                ...
                <br>
                   ...
                   <a href="<?php echo base_url("admin/data/resume_arsip/$detail_sampel[id_permohonan]"); ?>" class="btn btn-primary hidden-print"><i class="fa fa-chevron-left"></i> Kembali</a>
