...
<div id="page-wrapper">
    <div class="box-header">
        <h3 class="box-title hidden-print" style="font-size: 20px; opacity: 0.7; margin-left: 4px"><b>Surat Penugasan Pengujian</b></h3>
    </div>
    <section id="page-inner">
        <div class="box box-info">
            <div class="box-body">
                <table class="table table-bordered tebal">
                    <thead>
                        <tr>
                            ...
                            <th>
                                <h6 class="text-center". style="font-weight: 600;">Kode Formn :</h6>
                ...
                <a href="<?php echo base_url("admin/data/penugasan/$pengajuan[id_permohonan]") ?>" class="btn btn-primary hidden-print "><i class="fa fa-chevron-left "></i> Kembali</a>
