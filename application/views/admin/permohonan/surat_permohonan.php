	...
	<section id="page-inner">
		<div class="box box-info">
			<div class="box-body">
				...
				<h4 class="text-center"><strong><b>No: <?php echo $detail['nomor_permohonan']; ?></b></strong></h4>
				<br>
				<br>
				<br>
				<br>
				...
				<a href="<?php echo base_url("admin/data/permohonan"); ?>" class="btn btn-primary btn-sm hidden-print"><i class="fa fa-chevron-left"></i> Kembali</a>
				<a href="#" onclick="window.print();" class="btn btn-sm btn-success hidden-print pull-right"><i class="fa fa-print"></i> Print</a>
