			...
			<div class="box-body">
				<form method="POST">
					...
					<div class="form-group">
						...
						<textarea class="form-control ckeditor" name="spesifikasi_sampel"><?php echo $sampel['spesifikasi_sampel']; ?></textarea> 
					</div>
					<div class="form-group">
					...
					<a href="<?php echo base_url("admin/data/sampel/$sampel[id_sampel]") ?>" class=" btn btn-primary"><i class="fa fa-chevron-left"></i> Kembali</a>
					<button class="btn btn-success pull-right" >Lanjutkan <i class="fa fa-chevron-right"></i> </button>
				</form>
