<div id="page-wrapper">
    <div class="box-header">
        <h3 class="box-title hidden-print" style="font-size: 20px; opacity: 0.7; margin-left: 4px"><b>Surat Detail Sampel</b></h3>
    </div>
    <section id="page-inner">
        <div class="box box-info">
            <div class="box-body">
                ...
                <br>
                <a href="<?php echo base_url("admin/data/sampel/$detail_sampel[id_permohonan]") ?>" class="btn btn-primary hidden-print "><i class="fa fa-chevron-left"></i> Kembali</a>
