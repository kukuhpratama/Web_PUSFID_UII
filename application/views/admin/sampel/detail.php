<div id="page-wrapper">
    <div class="box-header">
        <h3 class="box-title hidden-print" style="font-size: 20px; opacity: 0.7; margin-left: 4px"><b>Detail Sampel</b></h3>
    </div>
            ...
            <div class="box-body">
                <form method="POST" autocomplete="off" enctype="multipart/form-data">
                    ...
                    <table class="table-bordered table">
                        <tbody>
                            <tr>
                                <td width="550">Jenis Sampel : <b><?php echo $detail_sampel['jenis_sampel']; ?></b></td>
                                <td></td>
                            </tr>
                        </tbody>
                    </table>
                    <div class="form-group">
                        ...
                        <input type="text" name="pabrik_sampel" class="flat flat-sm form-control" required>
                    </div>
                    <div class="form-group">
                        <label>Nomor Seri</label>
                        <input type="text" name="nomor_seri_sampel" class="flat flat-lg form-control" required>
                    </div>
                    <div class="form-group">
                        <label>Model</label>
                        <input type="text" name="model_sampel" class="flat flat-lg form-control" required>
                    </div>
                  <!--   <div class="form-group">
                    ...
                    <div class="form-group">
                        ...
                        <input type="file" name="foto_ime" class="flat flat-lg form-control">
                    </div>
                    <div class="form-group">
                        <label>Kondisi Sampel</label>
                        <select class="flat flat-sm form-control" name="Kondisi_sampel" required>
                   ...
                   <!--  <div class="form-group">
                        ...
                        <input type="text" name="jml_penyimpanan_sampel" class="flat flat-sm form-control" required>
                    </div> -->
