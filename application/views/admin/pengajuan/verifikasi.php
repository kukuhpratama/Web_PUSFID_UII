...
<div id="page-wrapper">
	<div class="box-header">
		<h3 class="box-title" style="font-size: 20px; opacity: 0.7; margin-left: 4px;"><b>Verifikasi Permohonan</b></h3>
	</div>
	<section id="page-inner">
		<div class="box box-info">
			<div class="box-body">
				...
				<span><b>No: <?php echo $detail['nomor_permohonan']; ?></b></span>
				...
				<form method="POST">
					<div class="form-group">
						...
						<select  class="form-control" name="id_pegawai1" required="">
							<option value="" selected="" disabled="">- Pilih Penanggung Jawab 1</option>
					...
					<div class="form-group">
						...
						<select class="form-control" name="id_pegawai2" required="">
							<option value="" selected="" disabled="">- Pilih Penaggung Jawab 2</option>
							<?php foreach ($user as $key => $value): ?>
								<option value="<?php echo $value['id_pegawai']; ?>"><?php echo $value['nama_pegawai']." - ".$value['jabatan_pegawai']; ?></option>
							<?php endforeach ?>
						</select>	
