...
class Download_arsip extends CI_Controller
{
	...
	public function P1($id_permohonan)
	{
		...
		$this->load->view("admin/download_arsip/p1",$data);
	...
	public function P2($id_permohonan)
	{
		...
		$this->load->view('admin/header',$data);
		$this->load->view("admin/sidebar",$data);
		$this->load->view("admin/download_arsip/p2",$data);
		$this->load->view("admin/footer");
	}
	...
	public function S1($id_permohonan)
	{
		...
		$this->load->view('admin/header',$data);
		$this->load->view("admin/sidebar",$data);
		$this->load->view("admin/download_arsip/s1",$data);
		$this->load->view("admin/footer");
	...
	public function S2($id_sampel)
	{
		...
		$this->load->view('admin/header',$data);
		$this->load->view("admin/sidebar",$data);
		$this->load->view("admin/download_arsip/s2",$data);
		$this->load->view("admin/footer");
	}
	...
	public function T1($id_permohonan)
	{
		...
		$this->load->view('admin/header',$data);
		$this->load->view("admin/sidebar",$data);
		$this->load->view("admin/download_arsip/t1",$data);
		$this->load->view("admin/footer");
	...
	public function MK($id_permohonan)
	{
		...
		$this->load->view('admin/header',$data);
		$this->load->view("admin/sidebar",$data);
		$this->load->view("admin/download_arsip/mk",$view,$data);
